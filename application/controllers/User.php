...
class User extends BaseController
{
    ...
    function getLists()
    {
        ...
        foreach ($userData as $user) {
            $created = date('jS M Y', strtotime($user->createdDtm));
            ...
            $data[] = [
                ...
                'createdDtm' => $created,
                'status' => $status,
                'action' => "<a class='btn btn-sm btn-info' href='".base_url('editOld/' . $user->userId)." '><i class='fa fa-pencil'></i></a><a class='btn btn-sm btn-danger deleteUser' href='#' data-userid='" . $user->userId . "'><i class='fa fa-trash'></i></a>",
            ];
            $i++;
        }
